            ...
            public Mono<Void> writeWith(final Publisher<? extends DataBuffer> body) {
                ...
                if (body instanceof Flux) {
                    ...
                    return super.writeWith(fluxBody.buffer().map(dataBuffers -> {
                        ...
                        System.out.println("requestId: "+request.getId()+", method: "+request.getMethod()+", req url: "+request.getURI());
                        try {
                            return dataBufferFactory.wrap(EncryptDecrypt.encrypt(responseBody).getBytes());
                        } catch (Exception e) {
